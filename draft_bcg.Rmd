...
ggsave(file="stressors_hists.pdf", stressors_hists)
...
ggsave(file="stressors_boxes.pdf", stressors_boxes)
...
ggsave(file="resources_hists.pdf", resources_hists)
...
ggsave(file="resources_boxes.pdf", resources_boxes)
...
ggsave(file="GSA_boxplot.pdf", bGSA)
...
## Save the resulting plot
ggsave(file="draft_massbaysBCG.pdf", massbaysBCG)
...
## Save the plot
ggsave(file="draft_habitatBCGs.pdf", habitatBCGs)
...
## Save the plot
ggsave(file="draft_embaymentBCGs.pdf", embaymentBCGs)
